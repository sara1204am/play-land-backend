...
export abstract class BaseAbstractController<T>
  implements BaseAbstractControllerInterface<T>
{
  abstract findAll(
    filter: string,
  ...
  abstract updateWithPatch(
    body: T,
    response: ResponseExpress,
    userData?: AccessToken,
  ): Promise<T>;
  abstract patchOrCreate(
    body: T,
    response: ResponseExpress,
    userData?: AccessToken,
  ): Promise<T>;
  abstract upsertWithWhere(
    filter: string,
    body: T,
    response: ResponseExpress,
    userData?: AccessToken,
